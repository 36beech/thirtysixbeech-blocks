...
type PaletteSource = ColorObject[] | null | undefined;
...
export const ColorSelector = ({ value, buttonLabel = "Choose Color", onChange }:ColorSelectorProps) => {
  const paletteSources:PaletteSource = useSettings("color.palette.theme", "color.palette.custom");
